                                        ...
                                        {item.Rates && item.Rates.length > 0 ? (
                                            <Typography variant="body2" color="textSecondary">
                                                <strong>Đánh giá trung bình:</strong> {(
                                                    item.Rates.reduce((sum, rate) => sum + parseInt(rate.Rate), 0) / item.Rates.length
                                                ).toFixed(1)} / 5
                                            </Typography>
                                        ) : (
                                            ''
